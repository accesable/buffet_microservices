...
namespace Shared.Migrations
{
    ...
    [Migration("20240515153504_AddIngredientAndAlterOrder")]
    partial class AddIngredientAndAlterOrder
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Shared.Ingredients.OrderDetail_IngredientStock", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("OrderDetail_IngredientStocks");
                });
            ...
            modelBuilder.Entity("Shared.Ingredients.OrderDetail_IngredientStock", b =>
                {
                    b.HasOne("Shared.Ingredients.Ingredient_Stock", "Ingredient_Stock")
                        .WithMany("OrderDetail_IngredientStocks")
                        .HasForeignKey("IngredientStockId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Shared.OrderModels.OrderDetail", "OrderDetail")
                        .WithMany("OrderDetail_IngredientStocks")
            ...
            modelBuilder.Entity("Shared.Ingredients.Ingredient_Stock", b =>
                {
                    b.Navigation("OrderDetail_IngredientStocks");
                });
